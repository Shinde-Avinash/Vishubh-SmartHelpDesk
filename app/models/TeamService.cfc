component singleton {
    ...
    function updateTeam( required numeric id, required string name, required string description ){
        fileAppend( expandPath("/handler_debug.txt"), "TeamService.updateTeam called for ID: #arguments.id#" & chr(13) & chr(10) );
    ...
    function deleteTeam( required numeric id ){
        fileAppend( expandPath("/handler_debug.txt"), "TeamService.deleteTeam called for ID: #arguments.id#" & chr(13) & chr(10) );
